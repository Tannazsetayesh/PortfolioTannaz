export default function ProjectsSection() {
  const projects = [
    ...
    },
    {
      ...
      websiteLink: "https://ai-marketing-audit-seven.vercel.app/",
    },
  ];
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="h-full flex flex-col">
                ...
                {(project.detailLink || project.githubLink || project.websiteLink) && (
                  <div className="flex flex-col gap-3 mt-auto">
                    {/* Top row: Live site button (full width if exists) */}
                    {project.websiteLink && (
                      <a
                        href={project.websiteLink}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full px-4 py-2.5 bg-indigo-600 text-white text-center rounded-lg font-medium text-sm transition-all duration-300 hover:bg-indigo-700 hover:shadow-md flex items-center justify-center gap-2"
                      >
                        <svg
                          className="w-4 h-4"
                          fill="none"
                    ...
                    {/* Bottom row: Details and GitHub buttons */}
